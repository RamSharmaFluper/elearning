        ...
        <div class="navbar-header">
          ...
          <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse" data-target="#navbar">
            ...
            <span class="ellipsis ellipsis-vertical">
              <img class="ellipsis-object" width="32" height="32" src="{{url('adminProfile')}}/{{$admin->image}}" alt="Teddy Wilson">
            </span>
          </button>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                  ...
                  <div class="dropdown-body">
                    <div class="list-group list-group-divided custom-scrollbar">
                      ...
                      <a class="list-group-item" href="#">
                        <div class="notification">
                          <div class="notification-media">
                            <img class="rounded" width="40" height="40" src="{{url('adminProfile')}}/{{$admin->image}}" alt="Teddy Wilson">
                          </div>
                          <div class="notification-content">
              ...
              <li class="dropdown hidden-xs">
                <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                  <img class="rounded" width="36" height="36" src="{{url('adminProfile')}}/{{$admin->image}}" alt="Teddy Wilson"> Teddy Wilson
