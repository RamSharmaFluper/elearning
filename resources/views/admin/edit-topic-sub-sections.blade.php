            ...
            <div class="layout-content-body">
                <div class="title-bar">
                    ...
                    <h1 class="title-bar-title">
                      <span class="d-ib">Edit  topic sub sections</span> /
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong>Edit  topic sub sections</strong>
                            ...
                            <div class="card-body edit-list1">
                                <table class="table table-striped table-bordered table-wrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $i=0;?>
                                    @foreach($topicSubSections as $education)
                                        <tr class="list-tr1" id="id_{{$education->id}}">
                                          <td class = "order">{{++$i}}</td>
                                          <td><input id="" type="text" name="education[]" value="{{$education->subject}}" class="edu-value" eduction_id="{{$education->id}}"/></td>
                                          <td>
...
@include('admin/footer')
    ...
    function deleteValue(val){
        ...
        if($.isNumeric(val)) {
             $.ajax({
                type:'POST',
                url:"{{url('delete-topic-sub-section')}}",
                data:{
                    "eduId":val
                },
    ...
    $(document).ready(function() {
        ...
        $('#addEducation').click(function() {
            ...
            $.ajax({
                type:'POST',
                url:"{{url('add-topic-sub-sections')}}",
                data:{
                    "educations":eduValue,
                    "eduId":eduId
                },
