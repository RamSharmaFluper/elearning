            ...
            <div class="layout-content-body">
                <div class="title-bar">
                    ...
                    <h1 class="title-bar-title">
                      <span class="d-ib">Edit Subject</span> /
                        ...
                        <div class="card">
                            ...
                            <div class="card-body edit-list1">
                                <table class="table table-striped table-bordered table-wrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $i=0;?>
                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin/footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    function deleteValue(val){
        ...
        if($.isNumeric(val)) {
             $.ajax({
                type:'POST',
                url:"<?php echo e(url('delete-subject')); ?>",
                data:{
                    "eduId":val
                },
    ...
    $(document).ready(function() {
        ...
        $('#addEducation').click(function() {
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(url('add-subject')); ?>",
                data:{
                    "educations":eduValue,
                    "eduId":eduId
                },
                success:function(data){
                    ...
                    if ( data == "0" ) {
                       $('.status').append("<div style='color:red'>Please try again.</div>");
                        ...
                        $('.status').append("<div style='color:red'>Subject update sucessfully.</div>");
                    }
                }
            });
        });
