            ...
            <div class="layout-content-body">
                <div class="title-bar">
                    ...
                    <h1 class="title-bar-title">
                      <span class="d-ib">Edit Exam</span> /
                        ...
                        <div class="card">
                            ...
                            <div class="card-body edit-list1">
                                <table class="table table-striped table-bordered table-wrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $i=0;?>
                                    <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="list-tr1" id="id_<?php echo e($education->id); ?>">
                                          <td class = "order"><?php echo e(++$i); ?></td>
                                          <td><input id="" type="text" name="education[]" value="<?php echo e($education->exam); ?>" class="edu-value" eduction_id="<?php echo e($education->id); ?>"/></td>
                                          <td>
...
<?php echo $__env->make('admin/footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    function deleteValue(val){
        ...
        if($.isNumeric(val)) {
             $.ajax({
                type:'POST',
                url:"<?php echo e(url('delete-exam')); ?>",
                data:{
                    "eduId":val
                },
