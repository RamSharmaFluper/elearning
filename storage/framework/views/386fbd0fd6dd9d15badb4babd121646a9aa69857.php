      ...
      <div class="layout-content">
        <div class="profile">
              ...
              <div class="profile-container">
                <div class="profile-card">
                  ...
                  <div class="profile-overview">
                    <h1 class="profile-name"><?php echo e($admin->name); ?></h1>
          ...
          <div class="profile-body">
                           ...
                           <div class="timeline-row">
                              <div class="media">
                                <div class="media-body">
                                  ...
                                  <p>
                                    <small><?php echo e($admin->email); ?></small>
                                  </p>
                                </div>
                              </div>
                           ...
                           <div class="timeline-row">
                              <div class="media">
                                <div class="media-body">
                                  ...
                                  <p>
                                    <small><?php echo e($admin->contact); ?></small>
                                  </p>
                                </div>
                              </div>
                           ...
                           <div class="timeline-row">
                              <div class="media">
                                <div class="media-body">
                                  ...
                                  <p>
                                    <small><?php echo e($admin->address); ?></small>
                                  </p>
                                </div>
                              </div>
                           ...
                           <div class="timeline-row">
                              <div class="media">
                                <div class="media-body">
                                  ...
                                  <p>
                                    <small><?php echo e($admin->location); ?></small>
                                  </p>
                                </div>
                              </div>
            ...
            <div class="col-md-12">
             <a href="<?php echo e(url('edit-profile')); ?>" class="btn btn-primary btn-sm pull-right" type="button">Edit profile</a> 
             </a>
             <a href="<?php echo e(url('change-password')); ?>"  class="btn btn-primary btn-sm pull-right margin-right-5" type="button">Change Password</a> 
              </a>
                  </div>
          </div>
        </div>
