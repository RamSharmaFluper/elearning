                            ...
                            <div class="card-body edit-list1">
                                <table class="table table-striped table-bordered table-wrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="list-tr1" id="id_<?php echo e($year->id); ?>">
                                          <td class="order"><?php echo e(++$i); ?></td>
                                          <td><input id="" type="text" name="" value="<?php echo e($year->year); ?>" class="edu-value"  year_id="<?php echo e($year->id); ?>"/></td>
                                          <td>
                                           <button class="del-list1 btn btn-danger btn-sm btn-labeled" type="button" onclick="deleteValue('<?php echo e($year->id); ?>') ">
...
<?php echo $__env->make('admin/footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    function deleteValue(val){
        ...
        if($.isNumeric(val)) {
             $.ajax({
                type:'POST',
                url:"<?php echo e(url('delete-year')); ?>",
                data:{
                    "eduId":val
                },
