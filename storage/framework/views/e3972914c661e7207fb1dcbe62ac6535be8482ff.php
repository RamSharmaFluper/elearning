                                ...
                                <table class="table table-striped table-bordered table-wrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="list-tr1" id="id_<?php echo e($education->id); ?>">
                                          ...
                                          <td><input id="" type="text" name="education[]" value="<?php echo e($education->education); ?>" class="edu-value" eduction_id="<?php echo e($education->id); ?>"/></td>
                                          <td>
...
<?php echo $__env->make('admin/footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    function deleteValue(val){
        ...
        if($.isNumeric(val)) {
             $.ajax({
                type:'POST',
                url:"<?php echo e(url('delete-educations')); ?>",
                data:{
                    "eduId":val
                },
    ...
    $(document).ready(function() {
        ...
        $('#addEducation').click(function() {
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(url('add-educations')); ?>",
                data:{
                    "educations":eduValue,
                    "eduId":eduId
                },
