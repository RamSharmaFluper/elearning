...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/profile.min.css')); ?>">
      ...
      <div class="navbar navbar-default">
        <div class="navbar-header">
          ...
          <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse" data-target="#navbar">
            <span class="sr-only"><?php echo e($admin->name); ?></span>
            <span class="arrow-up"></span>
            <span class="ellipsis ellipsis-vertical">
              <img class="ellipsis-object" width="32" height="32" src="<?php echo e(url('adminProfile')); ?>/<?php echo e($admin->image); ?>" alt="Teddy Wilson">
            </span>
          </button>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                  ...
                  <div class="dropdown-body">
                    <div class="list-group list-group-divided custom-scrollbar">
                      ...
                      <a class="list-group-item" href="#">
                        <div class="notification">
                          <div class="notification-media">
                            <img class="rounded" width="40" height="40" src="<?php echo e(url('adminProfile')); ?>/<?php echo e($admin->image); ?>" alt="Teddy Wilson">
                          </div>
                          <div class="notification-content">
              ...
              <li class="dropdown hidden-xs">
                <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                  <img class="rounded" width="36" height="36" src="<?php echo e(url('adminProfile')); ?>/<?php echo e($admin->image); ?>" alt="Teddy Wilson"> Teddy Wilson
            ...
            <nav id="sidenav" class="sidenav-collapse collapse">
              <ul class="sidenav">
                ...
                <li class="sidenav-item profilePageNav">
                  <a href="<?php echo e(url('profile')); ?>" aria-haspopup="true">
                    <span class="sidenav-icon icon icon-user"></span>
                    <span class="sidenav-label">Profile</span>
                  </a>
                </li>
                <li class="sidenav-item accountNav">
                  <a href="<?php echo e(url('users')); ?>" aria-haspopup="true">
                    <span class="sidenav-icon icon icon-users"></span>
                    <span class="sidenav-label">Users</span>
                  </a>
                
                <li class="sidenav-item questionMgtNav">
                  <a href="<?php echo e(url('question-mgt')); ?>" aria-haspopup="true">
                    <span class="sidenav-icon icon icon-users"></span>
                    <span class="sidenav-label">Question Managment</span>
                  </a>
                </li>
          </ul>
            </nav>
